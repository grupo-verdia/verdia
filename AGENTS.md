...
- **Prazo.** Days until grass is projected to hit 30 cm. Growth is 0.3 cm/day from October to March and 0.1 cm/day from April to September. Missing cm uses 20 for média and 5 for baixa. Alta is already over. Stored cm is used only when it still matches classe. No visible grass after classification has no prazo. Planejamento sorts by this, then rodovia, then km.
