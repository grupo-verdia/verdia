...
saved first, then classified. Close the tab: photos stay. Reopen the app:
leftover photos classify on their own. Excel import/export is on Rodovias. Imported rows have no photo (Sem imagem).
